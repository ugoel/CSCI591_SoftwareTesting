...
echo "user data: " . $user_data_credits[availablewifi] . ", xml credit: " . $total_credits_in_xml[1]/1000000.0;
							if ($user_data_credits[availabledata] < $total_credits_in_xml[0]/1000000.0)
								die("You do not have enough cellular data credits.");
							#changed < to >
							elseif ($user_data_credits[availablewifi] > $total_credits_in_xml[1]/1000000.0)
								die("You do not have enough Wi-Fi data credits.");
							else {
echo "in else";
